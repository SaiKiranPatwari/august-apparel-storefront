      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-4 lg:space-x-6">
            <button className="text-brand-charcoal hover:text-brand-rust transition-colors hidden sm:block">
              <Search className="h-5 w-5" />
            </button>
            <Link href="/account" className="text-brand-charcoal hover:text-brand-rust transition-colors hidden sm:block">
